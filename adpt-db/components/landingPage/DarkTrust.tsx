  ...
  return (
    <section className="relative py-16 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-cyan-500/10 to-blue-600/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
            ...
            return (
              ...
              >
                <div className="relative bg-slate-900/50 backdrop-blur-xl border border-slate-800/50 rounded-xl p-6 h-full hover:border-slate-700/50 transition-all duration-300">
                  <motion.div
                    className="w-12 h-12 bg-gradient-to-br from-cyan-500/20 to-blue-600/20 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300"
                    whileHover={{ rotate: 5 }}
                  >
                  ...
                  {/* Hover glow */}
                  <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-blue-600/5 opacity-0 group-hover:opacity-100 rounded-xl transition-opacity duration-300" />
                </div>
              </motion.div>
            );
          })}
        ...
        <motion.div
          ...
          className="relative bg-gradient-to-r from-slate-900/80 to-slate-800/80 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-12 max-w-4xl mx-auto overflow-hidden"
        >
          {/* Background Pattern */}
          ...
          <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              >
                <div className="text-white mb-2 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
                  {stat.value}
                </div>
          ...
          <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-blue-600/20 to-transparent rounded-tr-full" />
        </motion.div>
      </div>
    </section>
  );
